#!/usr/bin/env python3
"""
signal_meta.py - Signal Video Player User Metadata Store
=========================================================
Tracks user annotations, favourites, custom labels, and seen status
for videos. Persisted locally to 'signal_player_meta.json'.

Security guarantees:
  - Stores ONLY message/item IDs and user metadata.
  - Zero encryption keys, zero media content stored on disk.
"""
